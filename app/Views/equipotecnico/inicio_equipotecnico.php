                ...
                <div class="col-12">
                    ...
                    <ul class="nav nav-tabs d-flex justify-content-between" id="myTab<?= $index ?>" role="tablist">
                        <li class="nav-item flex-fill">
                            <a class="nav-link active text-center" id="goles-tab<?= $index ?>" data-bs-toggle="tab" href="#goles<?= $index ?>" role="tab" aria-controls="goles<?= $index ?>" aria-selected="true">Goles</a>
                        </li>
                        <li class="nav-item flex-fill">
                            <a class="nav-link text-center" id="cambios-tab<?= $index ?>" data-bs-toggle="tab" href="#cambios<?= $index ?>" role="tab" aria-controls="cambios<?= $index ?>" aria-selected="false">Cambios</a>
                        </li>
                        <li class="nav-item flex-fill">
                            <a class="nav-link text-center" id="tarjetas-tab<?= $index ?>" data-bs-toggle="tab" href="#tarjetas<?= $index ?>" role="tab" aria-controls="tarjetas<?= $index ?>" aria-selected="false">Tarjetas</a>
                        </li>
                    </ul>
